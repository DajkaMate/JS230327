...
function TimereFresh()
{
    ...
    document.getElementById("time").innerHTML = Zero(hour) + ":" + Zero(min) + ":" + Zero(sec);
    document.getElementById("date").innerHTML = year + " " + MonthName(month) + " " + day + "." + " " + MonthName(week) + "<br>" + Havinev(year,month,day);
}
